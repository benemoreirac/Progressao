...
from .views import CampoCreate, AtividadeCreate, StatusCreate, ClassesCreate, CampusCreate, ProgressaoCreate, SituacaoCreate, ComprovanteCreate, ValidacaoCreate
from .views import CampoUpdate, AtividadeUpdate, StatusUpdate, ClassesUpdate, CampusUpdate, ProgressaoUpdate, SituacaoUpdate, ComprovanteUpdate, ValidacaoUpdate, ServidorUpdate
from .views import CampoDelete, AtividadeDelete, StatusDelete, ClassesDelete, CampusDelete, ProgressaoDelete, SituacaoDelete, ComprovanteDelete, ValidacaoDelete
